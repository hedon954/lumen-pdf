...
3. `resetID` 变化（新翻译会话）清空 `lockedOrigin`。后续修订：翻译继续由 `ReadingOverlayWindow` 承载，新请求仍重置 `lockedOrigin`、`lockedPlacement` 和拖动后的 `customCenter`，见 [tdd-2026-09-01-native-translation-popover.md](tdd-2026-09-01-native-translation-popover.md)。
