...
version: v1.0.3
date: 2026-03-31
prd: prd/prd-2026-03-31-v103.md
predecessor:
...
后续修订：翻译成功 footer 的 AI 解释快捷入口与跨页笔记几何见 [tdd-2026-08-25-reader-overlay-shortcuts-cross-page-notes.md](tdd-2026-08-25-reader-overlay-shortcuts-cross-page-notes.md)。
