...
**后续修订（2026-09-01）**：翻译浮窗改用 `ReadingOverlayWindow` 的 Look Up 顺序（左、右、上、下）与实色箭头，并由 PDFKit 临时绘制黄色轻阴影选区；翻译继续复用定位和拖动状态，见 [Look Up 式翻译浮窗 TDD](tdd-2026-09-01-native-translation-popover.md)。操作栏和笔记仍用默认下、上、右、左顺序。
