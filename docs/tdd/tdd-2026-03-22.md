...
Swift UI (PDFKit)
    │
    │  UniFFI 自动生成绑定（reflect_pdf_core.swift）
    ▼
...
│   │   ├── reflect_pdf_core.swift
│   │   ├── reflect_pdf_coreFFI.h
│   │   ├── reflect_pdf_coreFFI.modulemap
│   │   └── libreflect_pdf_core.dylib
│   ├── project.yml                         # xcodegen 配置
│   ├── Info.plist
│   └── ReflectPDF.entitlements
│
