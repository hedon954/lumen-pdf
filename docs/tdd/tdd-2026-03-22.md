...
version: v1.0.0
date: 2026-03-22
prd: prd/prd-2026-03-22.md
next: tdd/tdd-2026-03-24.md
---
...
`#[serde(default)]` 保证缺失字段不导致反序列化失败（兼容旧缓存）。后续修订：模型 JSON 先经 `jsonrepair-rs` 再反序列化，见 [tdd-2026-08-21-llm-json-repair.md](tdd-2026-08-21-llm-json-repair.md)。
...
后续修订：不再用选区包围盒 `intersects`，改为 `TextLineMarkupMerge` 的按行区间并集/差集，见 [tdd-2026-08-21-markup-interval-merge.md](tdd-2026-08-21-markup-interval-merge.md)。
...
CREATE TABLE vocabulary_entries (
    ...
    context_sentence_translation  TEXT NOT NULL DEFAULT '',   -- v1.0.0 新增
    translation_source            TEXT NOT NULL DEFAULT '',
    annotation_id                 TEXT,
    created_at                    INTEGER NOT NULL,
    query_count                   INTEGER NOT NULL DEFAULT 0  -- v1.0.0 新增
);
...
后续修订：`POST /chat/completions` 按服务商关闭 thinking，见 [tdd-2026-08-21-llm-disable-thinking.md](tdd-2026-08-21-llm-disable-thinking.md)。
