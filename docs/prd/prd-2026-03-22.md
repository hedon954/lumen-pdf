...
后续修订：所有 LLM chat 请求显式关闭 thinking，见 [prd-2026-08-21-llm-disable-thinking.md](prd-2026-08-21-llm-disable-thinking.md)。后续修订：单词/整句翻译在解析模型 JSON 前做 json repair，markdown 围栏等小失误不再导致整次失败，见 [prd-2026-08-21-llm-json-repair.md](prd-2026-08-21-llm-json-repair.md)。
