...
version: v1.0.0
date: 2026-03-22
tdd: tdd/tdd-2026-03-22.md
next: prd/prd-2026-03-31.md
related:
  - tdd/tdd-2026-03-24.md
  - tdd/tdd-2026-03-25.md
  - tdd/tdd-2026-03-26.md
...
后续修订：LLM chat 请求按服务商关闭 thinking，见 [prd-2026-08-21-llm-disable-thinking.md](prd-2026-08-21-llm-disable-thinking.md)。后续修订：单词/整句翻译在解析模型 JSON 前做 json repair，markdown 围栏等小失误不再导致整次失败，见 [prd-2026-08-21-llm-json-repair.md](prd-2026-08-21-llm-json-repair.md)。
...
- **Toggle 语义**：选区与已有自由标注重叠 → 合并；完全覆盖已有标注 → 移除（关闭）。后续修订：重叠与合并改为按文本行一维区间，禁止用整段选区包围盒误删未选中的行，见 [prd-2026-08-21-markup-interval-merge.md](prd-2026-08-21-markup-interval-merge.md)。
...
后续修订：部分覆盖改为同一文本行上的区间并集，而不是整段 `union bounds`，见 [prd-2026-08-21-markup-interval-merge.md](prd-2026-08-21-markup-interval-merge.md)。
