...
- 先提问再解释：选区解释前可以输入自己的疑问；不输入时直接走默认解释，回车也可提交。
...
- 最新 PRD：[docs/prd/prd-2026-06-26-v1011.md](docs/prd/prd-2026-06-26-v1011.md)
- 最新 TDD：[docs/tdd/tdd-2026-06-26-v1011.md](docs/tdd/tdd-2026-06-26-v1011.md)
